...
$consulta800 = "SELECT * FROM " .TABLE_PREFIX."mod_bakery_order WHERE order_id = '$order_id'";

$sql_result1 = $database->query($consulta800);
...
/* echo $consulta802 = "SELECT co_mod_bakery_items.item_id,co_mod_bakery_items.title, co_mod_bakery_images.item_id,co_mod_bakery_images.filename
FROM co_mod_bakery_items, co_mod_bakery_images
where
co_mod_bakery_items.item_id = co_mod_bakery_images.item_id ";
  */				
				
			//	$consulta801 = "SELECT title, shipping, description FROM " .TABLE_PREFIX."mod_bakery_items WHERE item_id = '$row1[item_id]'";
			
				$consulta801 = "SELECT 
				co_mod_bakery_items.title, 
				co_mod_bakery_items.shipping,
				co_mod_bakery_items.description,
				co_mod_bakery_images.item_id,
				co_mod_bakery_images.filename 
				FROM " .TABLE_PREFIX."mod_bakery_items, " .TABLE_PREFIX."mod_bakery_images
				WHERE co_mod_bakery_items.item_id = '$row1[item_id]' and
				co_mod_bakery_items.item_id = co_mod_bakery_images.item_id ";
				
				$sql_result2 = $database->query($consulta801);
