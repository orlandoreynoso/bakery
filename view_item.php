...
// Get item info
/*
SELECT item_id,section_id,page_id,group_id,active,position,title,sku,stock,price,shipping,tax_rate,definable_field_0,definable_field_1,
definable_field_2,link,description,full_desc,modified_when,modified_by,created_when,created_by
FROM co_mod_bakery_items
WHERE item_id = '316' AND active = '1'
*/

/*
echo $consulta500 = "SELECT * FROM ".TABLE_PREFIX."mod_bakery_items WHERE item_id = '".ITEM_ID."' AND active = '1'";
*/

$consulta500 = "SELECT item_id,section_id,page_id,group_id,active,position,title,definable_field_0,definable_field_1,
definable_field_2,link,description,full_desc,modified_when,modified_by,created_when,created_by FROM ".TABLE_PREFIX."mod_bakery_items WHERE item_id = '".ITEM_ID."' AND active = '1'";

$query_item = $database->query($consulta500);
