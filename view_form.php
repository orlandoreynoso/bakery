...
if ($setting_zip_location == "end") {
	...
	"cust_company" => addslashes($MOD_BAKERY['TXT_CUST_COMPANY']), 
	"cust_first_name" => addslashes($MOD_BAKERY['TXT_CUST_FIRST_NAME']), 
	"cust_last_name" => addslashes($MOD_BAKERY['TXT_CUST_LAST_NAME']), 
/*	"cust_tax_no" => $MOD_BAKERY['TXT_CUST_TAX_NO'], 
